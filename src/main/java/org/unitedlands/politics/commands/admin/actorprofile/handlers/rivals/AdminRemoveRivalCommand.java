...
public class AdminRemoveRivalCommand extends BaseCommandHandler<UnitedPolitics> {

    public AdminRemoveRivalCommand(UnitedPolitics plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        if (args.length != 2) {
            Messenger.sendMessage(sender, messageProvider.getList("messages.usages.rival.remove"), null,
        ...
        if (actorRivals != null) {
            ...
            if (rivalEntry != null) {
                ...
                Messenger.sendMessage(sender, messageProvider.get("messages.errors.actorprofile.rival-missing"), null,
                        messageProvider.get("messages.prefix"));
            }
        } else {
            Messenger.sendMessage(sender, messageProvider.get("messages.errors.actorprofile.rival-missing"), null,
