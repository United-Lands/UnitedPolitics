...
@UnitedSubCommand(
    ...
    name = "set", 
    usage = "/upa reputation set <observer> <subject> <key> <value>",
    catchAll = true
)
public class CmdAdminReputationSet implements UnitedCommandExecutor {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        try {
            ...
            United.messenger().send(sender, "errors.general.number-format-error");
            return;
        }
        ...
        if (ReputationManager.instance().addOrUpdateReputationScoreEntry(entry)) {
            United.messenger().send(sender, "success.reputation.set",
